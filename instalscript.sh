...
if [ ! -d "$INSTALL_DIR" ]; then
    ...
    wget https://raw.githubusercontent.com/flys345/ADM-VPS-MX-MOD-FLYS_ANDROID/master/zzupdate-master/zzupdate.default.conf -O /usr/local/vpsmxup/vpsmxup.default.conf  &> /dev/null
	#chmod +x /usr/local/vpsmxup/vpsmxup.default.conf 
	rm -rf /usr/local/vpsmxup/vpsmxup.sh
    wget https://raw.githubusercontent.com/flys345/ADM-VPS-MX-MOD-FLYS_ANDROID/master/zzupdate-master/zzupdate.sh -O /usr/local/vpsmxup/vpsmxup.sh &> /dev/null
	chmod +x /usr/local/vpsmxup/vpsmxup.sh
	rm -rf /usr/bin/vpsmxup
    wget https://raw.githubusercontent.com/flys345/ADM-VPS-MX-MOD-FLYS_ANDROID/master/zzupdate-master/zzupdate.sh -O /usr/bin/vpsmxup &> /dev/null
