...
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2ZseXMzNDUvQURNLVZQUy1NWC1NT0QtRkxZU19BTkRST0lEL21hc3Rlcg=="
SUB_DOM='base64 -d'
...
function_verify () {
  permited=$(curl -sSL "https://raw.githubusercontent.com/flys345/ADM-VPS-MX-MOD-FLYS_ANDROID/master/Control-IP")
...
echo 'echo "" '>> .bashrc                                               
echo 'echo -e "\033[92m        Creditos: @Thony_DroidYT "'>> .bashrc
echo 'echo "" '>> .bashrc                   
...
msg -bar2
msg -bar2
msg -ama "     [ VPS - MX - SCRIPT \033[1;97m ❌ MOD By @FlysAndroidPeru ❌\033[1;33m ]"
msg -ama "     [ VPS - MX - SCRIPT \033[1;97m ❌ Creditos: @Thony_DroidYT ❌\033[1;33m ]"
...
error_fun () {
msg -bar2 && msg -verm "$(source trans -b pt:${id} "Esta Llave Era de Otro Servidor Por tanto Fue Excluida"|sed -e 's/[^a-z -]//ig') " && msg -bar2
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "KEY INVALIDA!") ]]; then
   msg -bar2
   msg -ama "$(source trans -b pt:${id} "BIENVENIDO, OBRIGADO POR UTILIZAR"|sed -e 's/[^a-z -]//ig'): \033[1;31m[NEW-ULTIMATE]"
